    ...
    >
      <header className="max-w-3xl space-y-4">
        ...
        <p className="glass-body text-lg">
          This page will visualize themes, affect, concreteness, and
          hallucinations. We are prototyping a layered storytelling dashboard.
        </p>
      </header>
      <div
      ...
      >
        <div
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_30%_-10%,rgba(245,158,11,0.25),transparent_65%),radial-gradient(circle_at_90%_40%,rgba(79,70,229,0.18),transparent_65%)]"
          aria-hidden="true"
        />
        <div className="glass-scrim relative max-w-md space-y-3">
          ...
          <p className="glass-body">
            Expect comparisons of hopeful and cautionary affect, time vs. place
            anchors, and a hallucination radar. In the meantime, explore the
            archive for raw context.
          </p>
        </div>
      </div>
    </section>
